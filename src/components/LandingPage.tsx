        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto mb-8">
              لا تدفع آلاف الجنيهات في اشتراكات البرامج الشهرية. تصفح أكثر من <strong className="text-gray-950 font-bold">80 أداة Micro SaaS</strong> جاهزة، جربها حياً، واحصل على الكود المصدري الكامل (.ZIP) لتبدأ مشروعك أو تعيد بيعها لعملائك.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto text-right">
              ...
              <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-xs">
                <div className="text-2xl sm:text-3xl font-black text-indigo-600 mb-1">80+</div>
      ...
      <section className="py-20 bg-gray-50/70 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            ...
            >
              <span>عرض جميع المنتجات الـ 80</span>
              <ArrowLeft size={16} />
            </button>
          </div>
